...
- Choosing between committing to one path and keeping options open (pair with [regret-minimization](../regret-minimization/SKILL.md) for the personal-cost side of the same choice)
...
- Pressure-testing a contrarian bet before committing (pair with [seven-questions-test](../seven-questions-test/SKILL.md) — its "secret" and "durability" questions are the thesis-quality checks)
