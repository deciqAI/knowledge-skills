...
This is the capstone skill of the Zero to One set — it operationalizes the others. Compose with [monopoly-vs-competition](../monopoly-vs-competition/SKILL.md) (Q3 in depth) · [zero-to-one-secrets](../zero-to-one-secrets/SKILL.md) (Q7 in depth) · [last-mover-advantage](../last-mover-advantage/SKILL.md) (Q6 in depth) · [definite-optimism](../definite-optimism/SKILL.md) (Q2's worldview) · [contrarian-question](../contrarian-question/SKILL.md) (the interview form of Q7) · [bullseye-traction-channels](../bullseye-traction-channels/SKILL.md) (Q5 in depth) · [checklist](../checklist/SKILL.md) (why written gates beat memory).
...
4. **Q3 Monopoly.** Are you starting with a big share of a small market? Name the small market, its size, and your plausible share of it — not the trillion-dollar TAM sliced to a "conservative 1%." Score 1–5. See [monopoly-vs-competition](../monopoly-vs-competition/SKILL.md). *Gate: same rule.*
...
6. **Q5 Distribution.** Do you have a way not just to create your product but to *deliver* it? Name the channel, the unit economics of acquiring one customer through it, and evidence the channel works at your price point. "It will spread by word of mouth" is not an answer. Score 1–5. See [bullseye-traction-channels](../bullseye-traction-channels/SKILL.md). *Gate: same rule.*
7. **Q6 Durability.** Will your market position be defensible 10 and 20 years from now? Write what stops a well-funded imitator, and what the position looks like after the current technology wave commoditizes. Score 1–5. See [last-mover-advantage](../last-mover-advantage/SKILL.md). *Gate: same rule.*
8. **Q7 Secret.** Have you identified a unique opportunity that others don't see? Write the specific true-but-unpopular belief the business is built on, and why the people who could act on it haven't. Score 1–5. See [zero-to-one-secrets](../zero-to-one-secrets/SKILL.md) and [contrarian-question](../contrarian-question/SKILL.md). *Gate: same rule.*
...
4. **Treat "might work" (5–6/7) as a work order, not a pass.** The output of a 5–6 tally is a named plan and date for each weak question — see [checklist](../checklist/SKILL.md) for making that plan survive contact with a busy quarter.
