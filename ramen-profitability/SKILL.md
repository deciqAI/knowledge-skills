...
description: "Activate when: a founder needs to know if the company survives without more funding; 'are we default alive or default dead', deciding to cut burn or raise, bootstrapping to survival; runway math. Do NOT activate when: the company is already comfortably profitable and the question is scaling, not survival."
---
