# Sources — swot-analysis

> *Primary sources for the [swot-analysis](../SKILL.md) skill.*

- Andrews, K.R. (1971). *The Concept of Corporate Strategy.* Dow Jones-Irwin. The academic systematization of the framework at Harvard Business School. Verbatim quote above from p. 28.
- Learned, E.P., Christensen, C.R., Andrews, K.R., & Guth, W.D. (1969). *Business Policy: Text and Cases.* Richard D. Irwin. The Harvard textbook that formalized internal/external analysis as the "fit" problem.
