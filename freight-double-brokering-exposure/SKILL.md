...
> **Industry front door for [second-order-thinking](../../deciqai-knowledge-skills/second-order-thinking/SKILL.md).** Adds domain triggers, example, packs. Parent Process unchanged.
> **Not legal advice.**
...
---
Part of **deciqAI Knowledge Skills**. Core method: [second-order-thinking](../../deciqai-knowledge-skills/second-order-thinking/SKILL.md).
