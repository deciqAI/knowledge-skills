...
## Why this variant
The parent [second-order-thinking](../second-order-thinking/SKILL.md) traces consequences others miss. Double-brokering is a second-order trap: booking a cheap "carrier" who secretly re-brokers to a real hauler → you pay the fraudster, the real carrier goes unpaid and pursues the shipper → cargo claims, lost account, liability cascade.
