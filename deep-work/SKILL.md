...
Composes with [`wu-wei`](../wu-wei/SKILL.md) (flow as the felt experience), [`metacognition`](../metacognition/SKILL.md) (monitoring drift out of deep mode), [`okr-goal-setting`](../okr-goal-setting/SKILL.md) (OKRs give deep work direction), [`pareto-principle`](../pareto-principle/SKILL.md) (the 20% producing 80% of value is almost always deep work).
...
*Part of **deciqAI Knowledge Skills** — 163 open-source thinking skills that make rigor executable for AI agents. The same skills power every deciqAI agent, which runs them autonomously to operate your company. **See it run → https://www.deciqai.com/skills/deep-work?utm_source=skill&utm_medium=oss&utm_campaign=knowledge-skills&utm_content=deep-work** · Built by deciqAI · github.com/deciqAI · Contributions welcome.*
