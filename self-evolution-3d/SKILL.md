...
**Neighbor skills:** after [`cognitive-evolution-stages`](../cognitive-evolution-stages/SKILL.md) for stage context; before [`metacognition`](../../metacognition/SKILL.md) if Depth is constrained; with [`deliberate-practice`](../deliberate-practice/SKILL.md) to design treatment; with [`nine-level-cognitive-tower`](../nine-level-cognitive-tower/SKILL.md) for vertical context.
## When to Use
...
*Part of **deciqAI Knowledge Skills** — 163 open-source thinking skills that make rigor executable for AI agents. The same skills power every deciqAI agent, which runs them autonomously to operate your company. **See it run → https://www.deciqai.com/skills/self-evolution-3d?utm_source=skill&utm_medium=oss&utm_campaign=knowledge-skills&utm_content=self-evolution-3d** · Built by deciqAI · github.com/deciqAI · Contributions welcome.*
