...
This skill is the explicit **dual of [first-mover-advantage](../first-mover-advantage/SKILL.md)**. Lieberman & Montgomery (1988) showed both first-mover advantages *and* disadvantages exist — free-rider effects, uncertainty resolution, incumbent inertia — leaving open which force dominates in a given market. Last-mover analysis supplies the missing decision rule: the **endgame test**. Define the market's terminal structure first; whichever entry timing best positions you to *hold* that terminal position is the right one. Compose with [economic-moat](../economic-moat/SKILL.md) (what makes the endgame position defensible) · [monopoly-vs-competition](../monopoly-vs-competition/SKILL.md) (why the endgame prize is monopoly profits, not market share) · [network-effects](../network-effects/SKILL.md) (the most common consolidation mechanism) · [compound-interest](../compound-interest/SKILL.md) (why decade-out cash flows dominate the valuation).
...
**Skip when:** the question is diagnosing an *existing* pioneer's defenses or a follower's attack route — use [first-mover-advantage](../first-mover-advantage/SKILL.md) directly; the market is so early that its endgame structure is unknowable and claiming one would be fiction (run cheap experiments instead); the decision is short-horizon execution where a 10-year frame adds nothing.
...
2. **Check fit.** Match their situation against *Use when / Skip when*. If they're really asking "is the pioneer's lead defensible?", redirect to [first-mover-advantage](../first-mover-advantage/SKILL.md). If the market's final shape is honestly unknowable, say so and point to cheap experiments instead.
...
1. **Endgame definition.** Describe the market's terminal structure in one paragraph: when consolidation is over, how many players remain, what the winner controls (the choke point: distribution, data, standard, network, brand), and what the winner's cash flows look like. Name the consolidation mechanism explicitly ([network-effects](../network-effects/SKILL.md), scale economics, switching costs, proprietary tech per [economic-moat](../economic-moat/SKILL.md)). *Gate: if you cannot describe the endgame concretely enough to disagree with, the market is too early for this tool → exit to cheap experiments.*
...
- [ ] The dual was honored: first-mover advantages AND disadvantages ([first-mover-advantage](../first-mover-advantage/SKILL.md)) considered, with the endgame test deciding which applies here
