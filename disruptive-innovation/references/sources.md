# Sources — disruptive-innovation

> *Primary sources for the [disruptive-innovation](../SKILL.md) skill.*

- Christensen, Clayton M. (1997). *The Innovator's Dilemma: When New Technologies Cause Great Firms to Fail.* Harvard Business School Press. Verbatim: "The companies that are most likely to be killed by disruptive technologies are those that have honed the skills of listening carefully to their most profitable customers and then giving those customers more of what they want." (p. xii). Full text available via HBS: https://www.hbs.edu/faculty/Pages/item.aspx?num=6771

- Christensen, Clayton M. & Bower, Joseph L. (1996). "Customer Power, Strategic Investment, and the Failure of Leading Firms." *Strategic Management Journal*, 17(3), 197–218. Verbatim: "Entrant firms beat out incumbent firms when a technology or business model change allows new companies to offer a product or service that is simpler and cheaper, and therefore accessible to new customers or less-demanding customers who had previously been unable to afford or use the incumbent's offering." (p. 198). DOI: https://doi.org/10.1002/smj.4250170303
